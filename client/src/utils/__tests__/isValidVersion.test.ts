...
it("returns false for malformed versions", () => {
  ...
  console.error = () => {}
  expect(isValidVersion(undefined, "1.2.3")).toEqual(false)
  expect(isValidVersion("1.2.3", undefined)).toEqual(false)
  expect(isValidVersion({}, "1.2.3")).toEqual(false)
  expect(isValidVersion("1.2.3", {})).toEqual(false)
  expect(isValidVersion([], "1.2.3")).toEqual(false)
  expect(isValidVersion("1.2.3", [])).toEqual(false)
  expect(isValidVersion(123, "1.2.3")).toEqual(false)
  expect(isValidVersion("1.2.3", 123)).toEqual(false)
  expect(isValidVersion(() => {}, "1.2.3")).toEqual(false)
  expect(isValidVersion("1.2.3", () => {})).toEqual(false)
