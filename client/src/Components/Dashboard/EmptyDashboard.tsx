  ...
  return (
    <div id="emptyDashboard">
      <div>
        ...
        <Link to={ROUTES.LANDING}><Button>Home Page <FontAwesomeIcon icon={faHome}/></Button></Link>
        <br/><br/>
        <div>- or -</div>
        <br/>
        ...
        <label htmlFor="loadDataFile" className="btn btn-primary">Upload JSON File <FontAwesomeIcon icon={faUpload}/></label> &nbsp;
        <input id="loadDataFile" type="file" accept=".json" onChange={uploadDataFile}/>
      </div>
    </div>
  )
}
